...
function O(u, e) { if (e) {
    ...
    return u.replace(m.escapeReplaceNoEncode, de); return u; }
function X(u) { try {
...
function J(u, e) { var _b; let t = u.replace(m.findPipe, (i, s, a) => { let o = !1, l = s; for (; --l >= 0 && a[l] === "\\";)
    o = !o; return o ? "|" : " |"; }), n = t.split(m.splitPipe), r = 0; if (n[0].trim() || n.shift(), n.length > 0 && !((_b = n.at(-1)) === null || _b === void 0 ? void 0 : _b.trim()) && n.pop(), e)
    if (n.length > e)
        n.splice(e);
    else
        for (; n.length < e;)
...
function E(u, e, t) { let n = u.length; if (n === 0)
...
function ge(u, e) { if (u.indexOf(e[1]) === -1)
    return -1; let t = 0; for (let n = 0; n < u.length; n++)
    if (u[n] === "\\")
        n++;
    else if (u[n] === e[0])
        t++;
...
function fe(u, e = 0) { let t = e, n = ""; for (let r of u)
    if (r === "	") {
        let i = 4 - t % 4;
        n += " ".repeat(i), t += i;
    }
...
function it(u, e, t) {
    ...
    let r = n[1];
    return e.split(`
`).map(i => { let s = i.match(t.other.beginningSpace); if (s === null)
        return i; let [a] = s; return a.length >= r.length ? i.slice(r.length) : i; }).join(`
`);
}
var w = class {
...
${c}` : c;
                ...
                if (this.lexer.state.top = !0, this.lexer.blockTokens(c, s, !0), this.lexer.state.top = d, n.length === 0)
                    break;
                let h = s.at(-1);
                if ((h === null || h === void 0 ? void 0 : h.type) === "code")
                    break;
...
`, e = e.substring(H.length + 1), d = I.slice(f);
            ...
            for (let l of i.items) {
                if (this.lexer.state.top = !1, l.tokens = this.lexer.blockTokens(l.text, []), l.task) {
                    if (l.text = l.text.replace(this.rules.other.listReplaceTask, ""), ((_b = l.tokens[0]) === null || _b === void 0 ? void 0 : _b.type) === "text" || ((_c = l.tokens[0]) === null || _c === void 0 ? void 0 : _c.type) === "paragraph") {
    ...
    table(e) {
        ...
        if (!t || !this.rules.other.tableDelimiter.test(t[2]))
            return;
        let n = J(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = ((_b = t[3]) === null || _b === void 0 ? void 0 : _b.trim()) ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
...
` ? t[1].slice(0, -1) : t[1];
    ...
    emStrong(e, t, n = "") { let r = this.rules.inline.emStrongLDelim.exec(e); if (!r || r[3] && n.match(this.rules.other.unicodeAlphaNumeric))
    ...
    del(e, t, n = "") { let r = this.rules.inline.delLDelim.exec(e); if (!r)
        return; if (!(r[1] || "") || !n || this.rules.inline.punctuation.exec(n)) {
    ...
    url(e) { var _b, _c; let t; if (t = this.rules.inline.url.exec(e)) {
        let n, r;
        if (t[2] === "@")
            n = t[0], r = "mailto:" + n;
        else {
            let i;
            do
                i = t[0], t[0] = (_c = (_b = this.rules.inline._backpedal.exec(t[0])) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : "";
            while (i !== t[0]);
...
var x = class u {
    ...
    static get rules() { return { block: C, inline: z }; }
...
`), this.blockTokens(e, this.tokens);
    ...
    blockTokens(e, t = [], n = !1) {
        ...
        for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e;) {
            let r;
            if ((_c = (_b = this.options.extensions) === null || _b === void 0 ? void 0 : _b.block) === null || _c === void 0 ? void 0 : _c.some(s => (r = s.call({ lexer: this }, e, t)) ? (e = e.substring(r.raw.length), t.push(r), !0) : !1))
                continue;
...
` + r.raw, this.inlineQueue.at(-1).src = s.text) : this.tokens.links[r.tag] || (this.tokens.links[r.tag] = { href: r.href, title: r.title }, t.push(r));
            ...
            let i = e;
            if ((_d = this.options.extensions) === null || _d === void 0 ? void 0 : _d.startBlock) {
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
    ...
    inlineTokens(e, t = []) { var _b, _c, _d, _f, _g, _h; let n = e, r = null; if (this.tokens.links) {
        ...
        n = n.slice(0, r.index) + "++" + n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex); let i; for (; (r = this.tokenizer.rules.inline.blockSkip.exec(n)) != null;)
        i = r[2] ? r[2].length : 0, n = n.slice(0, r.index + i) + "[" + "a".repeat(r[0].length - i - 2) + "]" + n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex); n = (_d = (_c = (_b = this.options.hooks) === null || _b === void 0 ? void 0 : _b.emStrongMask) === null || _c === void 0 ? void 0 : _c.call({ lexer: this }, n)) !== null && _d !== void 0 ? _d : n; let s = !1, a = ""; for (; e;) {
        s || (a = ""), s = !1;
        let o;
        if ((_g = (_f = this.options.extensions) === null || _f === void 0 ? void 0 : _f.inline) === null || _g === void 0 ? void 0 : _g.some(p => (o = p.call({ lexer: this }, e, t)) ? (e = e.substring(o.raw.length), t.push(o), !0) : !1))
            continue;
        ...
        let l = e;
        if ((_h = this.options.extensions) === null || _h === void 0 ? void 0 : _h.startInline) {
            let p = 1 / 0, c = e.slice(1), d;
            this.options.extensions.startInline.forEach(h => { d = h.call({ lexer: this }, c), typeof d == "number" && d >= 0 && (p = Math.min(p, d)); }), p < 1 / 0 && p >= 0 && (l = e.substring(0, p + 1));
        }
...
var y = class {
    ...
    code({ text: e, lang: t, escaped: n }) {
        var _b;
        let r = (_b = (t || "").match(m.notSpaceStart)) === null || _b === void 0 ? void 0 : _b[0], i = e.replace(m.endingNewline, "") + `
`;
...
`;
    ...
    link({ href: e, title: t, tokens: n }) { let r = this.parser.parseInline(n), i = X(e); if (i === null)
        return r; e = i; let s = '<a href="' + e + '"'; return t && (s += ' title="' + O(t) + '"'), s += ">" + r + "</a>", s; }
    image({ href: e, title: t, text: n, tokens: r }) { r && (n = this.parser.parseInline(r, this.parser.textRenderer)); let i = X(e); if (i === null)
        return O(n); e = i; let s = `<img src="${e}" alt="${O(n)}"`; return t && (s += ` title="${O(t)}"`), s += ">", s; }
...
var b = class u {
    ...
    parse(e) { var _b, _c; let t = ""; for (let n = 0; n < e.length; n++) {
        let r = e[n];
        if ((_c = (_b = this.options.extensions) === null || _b === void 0 ? void 0 : _b.renderers) === null || _c === void 0 ? void 0 : _c[r.type]) {
    ...
    parseInline(e, t = this.renderer) { var _b, _c; let n = ""; for (let r = 0; r < e.length; r++) {
        let i = e[r];
        if ((_c = (_b = this.options.extensions) === null || _b === void 0 ? void 0 : _b.renderers) === null || _c === void 0 ? void 0 : _c[i.type]) {
...
var B = class {
    ...
    walkTokens(e, t) { var _b, _c; let n = []; for (let r of e)
        switch ((n = n.concat(t.call(this, r)), r.type)) {
            ...
            default: {
                let i = r;
                ((_c = (_b = this.defaults.extensions) === null || _b === void 0 ? void 0 : _b.childTokens) === null || _c === void 0 ? void 0 : _c[i.type]) ? this.defaults.extensions.childTokens[i.type].forEach(s => { let a = i[s].flat(1 / 0); n = n.concat(this.walkTokens(a, t)); }) : i.tokens && (n = n.concat(this.walkTokens(i.tokens, t)));
            }
        } return n; }
    use(...e) { let t = this.defaults.extensions || { renderers: {}, childTokens: {} }; return e.forEach(n => { let r = Object.assign({}, n); if (r.async = this.defaults.async || r.async || !1, n.extensions && (n.extensions.forEach(i => { if (!i.name)
    ...
    } "childTokens" in i && i.childTokens && (t.childTokens[i.name] = i.childTokens); }), r.extensions = t), n.renderer) {
        ...
        for (let s in n.hooks) {
            ...
            P.passThroughHooks.has(s) ? i[a] = p => { if (this.defaults.async && P.passThroughHooksRespectAsync.has(s))
                return (() => __awaiter(this, void 0, void 0, function* () { let d = yield o.call(i, p); return l.call(i, d); }))(); let c = o.call(i, p); return l.call(i, c); } : i[a] = (...p) => { if (this.defaults.async)
                return (() => __awaiter(this, void 0, void 0, function* () { let d = yield o.apply(i, p); return d === !1 && (d = yield l.apply(i, p)), d; }))(); let c = o.apply(i, p); return c === !1 && (c = l.apply(i, p)), c; };
        }
        r.hooks = i;
    } if (n.walkTokens) {
        let i = this.defaults.walkTokens, s = n.walkTokens;
        r.walkTokens = function (a) { let o = []; return o.push(s.call(this, a)), i && (o = o.concat(i.call(this, a))), o; };
    } this.defaults = Object.assign(Object.assign({}, this.defaults), r); }), this; }
    setOptions(e) { return this.defaults = Object.assign(Object.assign({}, this.defaults), e), this; }
    lexer(e, t) { return x.lex(e, t !== null && t !== void 0 ? t : this.defaults); }
    parser(e, t) { return b.parse(e, t !== null && t !== void 0 ? t : this.defaults); }
    parseMarkdown(e) { return (n, r) => { let i = Object.assign({}, r), s = Object.assign(Object.assign({}, this.defaults), i), a = this.onError(!!s.silent, !!s.async); if (this.defaults.async === !0 && i.async === !1)
        ...
        return (() => __awaiter(this, void 0, void 0, function* () { let o = s.hooks ? yield s.hooks.preprocess(n) : n, p = yield (s.hooks ? yield s.hooks.provideLexer() : e ? x.lex : x.lexInline)(o, s), c = s.hooks ? yield s.hooks.processAllTokens(p) : p; s.walkTokens && (yield Promise.all(this.walkTokens(c, s.walkTokens))); let h = yield (s.hooks ? yield s.hooks.provideParser() : e ? b.parse : b.parseInline)(c, s); return s.hooks ? yield s.hooks.postprocess(h) : h; }))().catch(a); try {
...
g.options = g.setOptions = function (u) { return L.setOptions(u), g.defaults = L.defaults, G(g.defaults), g; };
g.getDefaults = M;
g.defaults = T;
g.use = function (...u) { return L.use(...u), g.defaults = L.defaults, G(g.defaults), g; };
